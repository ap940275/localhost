...
<font style="font-size:12px;font-weight:bold"><input type="submit" name="submit" value="Send Feedback" class="btn btn-primary" /></font>
</div>
</form>';
}
?>
...
<span href="#" data-target="#login" style="color:lightyellow">Developed by Amit and Guna<br><br></span></div>
