...
<div class="form-group">
  ...
  <div class="col-md-12">
  <h1 align="center"><font color="red">Registration Form</h1></font>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your USN (Ex.1by18mca04)" class="form-control input-md" type="text" value="<?php
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Developed by Amit and Guna<br><br></span>
</div>
