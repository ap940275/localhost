...
<div class="row">
<div class="col-lg-6">
<span class="logo">Quiz Taker</span></div>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Developed by Amit and Guna</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Quiz Taker</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/logo.jpg" width=150 height=100 alt="kumardnj" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Amit and Guna</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9661773379</h4>
		<h4 style="font-family:'typo' ">kumardnj94@gmail.com</h4>
		<h4 style="font-family:'typo' ">BMSIT & M ,Bangalore </h4></div></div>
		</p>
      </div>
